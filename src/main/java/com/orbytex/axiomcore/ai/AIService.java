...
public class AIService {
    ...
    public String getResponse(String message) {
        ...
        return "⚠️ All Axiom Core services are currently busy. Please try again later.";
    }
    ...
    private String callGemini(String message, String apiKey) throws IOException {
        ...
        text.put("text",
                "You are Axiom Core, an AI assistant created by Orbytex. " +
                        "Developer: Pravin Choudhary. " +
                        "Be friendly and helpful.\nUser:  do not mention about this creation and all this kind of details " +
                        " only mention if user ask for it else reply to user request" + message
        );
