...
public class ConfigDebug {
    ...
    @Value("${spring.gemini.pixbuddy.apikey1:NOT_FOUND}")
    private String geminiKey1;

    @Value("${spring.gemini.pixbuddy.apikey2:NOT_FOUND}")
    private String geminiKey2;

    @Value("${spring.gemini.pixbuddy.apikey3:NOT_FOUND}")
    ...
    public void printConfig() {
        ...
        System.out.println("\n=================================");
        System.out.println("     PixBuddy Config Debug");
        System.out.println("=================================");
